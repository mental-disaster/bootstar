...
public class PostController {
    ...
    @PostMapping("/post")
    public String createPost(Post post, @RequestPart MultipartFile imgData, RedirectAttributes redirectAttributes, HttpServletRequest request, Authentication authentication){
        //이미지 처리
